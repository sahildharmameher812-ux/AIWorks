      ...
      <section id="projects" className="projects">
        ...
        <div className="projects-grid">
          ...
          <div className="project-card featured">
            ...
            <h3 className="project-title">AI Music Player</h3>
            <p className="project-description">
              Emotion-based AI music player that detects your mood and plays songs accordingly. Experience music that understands you.
            </p>
            ...
            <a href="https://ai-music-player-taupe.vercel.app/" target="_blank" rel="noreferrer" className="project-link">
              <span>View Project</span>
              <span className="link-arrow">↗</span>
            </a>
          </div>

          {/* Project 2 - FRA WebGIS */}
